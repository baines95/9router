...
export default function Header() {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4 bg-background/80 backdrop-blur-sm sticky top-0 z-20 transition-all">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem className="hidden md:block">
              {/* Sử dụng render của Base UI để tránh lồng thẻ <a> */}
