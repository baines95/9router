...
"hover:bg-muted/50",
 ...
 {model.name && (
 <span className="pl-1 text-xs italic text-muted-foreground/80">
 {model.name}
 </span>
 )}
 </div>
...
"rounded p-0.5 text-muted-foreground transition-opacity hover:bg-accent hover:text-foreground",
 ...
 <span className="pointer-events-none absolute top-5 left-1/2 mt-1 -translate-x-1/2 whitespace-nowrap text-xs text-muted-foreground opacity-0 transition-opacity group-hover/btn:opacity-100">
