...
export default function NewProviderPage() {
 ...
 <div
 className="size-10 rounded-lg flex items-center justify-center bg-bg border border-border/50"
 >
 <span
 ...
 {/* Error Message */}
 {errors.submit && (
 <div className="p-4 rounded-lg bg-red-50 dark:bg-destructive/10 border border-red-200 dark:border-red-800 text-destructive dark:text-destructive text-sm">
 {errors.submit}
 </div>
 )}
