...
export default function ClaudeToolCard({
 ...
 <p className="font-medium text-muted-foreground dark:text-muted-foreground text-sm">Chưa phát hiện Claude CLI</p>
 ...
 <span className="text-xs text-muted-foreground/60 italic truncate max-w-[200px]"title={claudeStatus.settings.env.ANTHROPIC_BASE_URL}>
 ...
 <div className="flex items-center gap-2">
 <span className="text-sm font-medium">Lọc tên hội thoại</span>
 <Tooltip text="Tự động trả lời các yêu cầu đặt tên hội thoại của Claude Code, giúp tiết kiệm token.">
 <Info className="size-3.5 text-muted-foreground cursor-help"/>
 </Tooltip>
 </div>
 <p className="text-xs text-muted-foreground">Tối ưu hóa token bằng cách giả lập phản hồi tên topic.</p>
 </div>
