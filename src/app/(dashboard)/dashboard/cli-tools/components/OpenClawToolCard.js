...
"8router": {
 ...
 <p className="font-medium text-muted-foreground dark:text-muted-foreground text-sm">Chưa phát hiện Open Claw CLI</p>
 ...
 <label className="text-xs font-medium uppercase tracking-tight text-muted-foreground">
 Cấu hình từng Agent
 </label>
 ...
 <div className="flex items-center gap-2">
 <span className="text-xs font-medium text-primary truncate max-w-[150px]"title={agent.name || agent.id}>
 {agent.name || agent.id}
 </span>
