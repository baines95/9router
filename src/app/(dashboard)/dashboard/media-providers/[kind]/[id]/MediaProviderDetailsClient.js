...
function EmbeddingExampleCard({ providerId }) {
 ...
 className="w-full px-3 py-1.5 text-sm border border-border/50 rounded-lg bg-background focus:outline-none focus:border-primary"
 >
 ...
 className="flex-1 px-3 py-1.5 text-sm border border-border/50 rounded-lg bg-background focus:outline-none focus:border-primary font-mono"
 ...
 useTunnel ?"border-primary/40 bg-primary/10 text-primary":"border-border/50 text-text-muted hover:text-primary"
 }`}
 >
 ...
 placeholder="sk-..."
 className="w-full px-3 py-1.5 text-sm border border-border/50 rounded-lg bg-background focus:outline-none focus:border-primary font-mono"
 />
 </Row>
 ...
 className="w-full px-3 py-1.5 pr-7 text-sm border border-border/50 rounded-lg bg-background focus:outline-none focus:border-primary"
 />
 {input && (
 <button
 type="button"
 ...
 <span className="text-xs font-semibold text-text-muted uppercase tracking-tight">Request</span>
 <div className="flex items-center gap-2">
 <button
...
function TtsExampleCard({ providerId }) {
 ...
 <button
 onClick={openModal}
 className="flex-1 px-3 py-1.5 text-sm border border-border/50 rounded-lg bg-background font-mono truncate text-left hover:border-primary/40 transition-colors"
 >
 {selectedLang
 ...
 <button
 onClick={openModal}
 className="flex items-center gap-1 text-xs px-2.5 py-1.5 rounded-lg border border-border/50 text-text-muted hover:text-primary hover:border-primary/40 transition-colors shrink-0"
 >
 ...
 :"border-border/50 text-text-muted hover:text-primary hover:border-primary/40"
 }`}
 >
 {v.name}{v.gender ? ` · ${v.gender[0].toUpperCase()}` :""}
 {v.free_users_allowed === true && (
 <span className="ml-1.5 px-1 py-0.5 text-xs font-semibold rounded bg-primary/10 text-primary border border-primary/20">Free</span>
 )}
 {v.free_users_allowed === false && (
 <span className="ml-1.5 px-1 py-0.5 text-xs font-semibold rounded bg-muted/30 text-muted-foreground border border-border/50">Paid</span>
 )}
 </button>
 ))}
 </div>
 ...
 className="w-full px-3 py-1.5 pr-7 text-sm border border-border/50 rounded-lg bg-background focus:outline-none focus:border-primary font-mono"
 />
 {voiceId && (
 <button
 type="button"
 ...
 <div className="mt-3">
 <div className="flex items-center justify-between mb-1.5">
 <span className="text-xs font-semibold text-text-muted uppercase tracking-tight">JSON Response</span>
 </div>
 ...
 <div>
 <span className="text-xs font-semibold text-text-muted uppercase tracking-tight">Response</span>
 ...
 >
 <div
 className="border border-border/50 rounded-xl w-full max-w-md mx-4 flex flex-col max-h-[80vh]"
 style={{ backgroundColor:"var(--color-bg)", isolation:"isolate"}}
 onClick={(e) => e.stopPropagation()}
 >
 {/* Header */}
 <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 shrink-0 rounded-t-xl">
 ...
 {modalError && <p className="text-xs text-destructive px-2 py-1">{modalError}</p>}
 {modalLoading ? (
